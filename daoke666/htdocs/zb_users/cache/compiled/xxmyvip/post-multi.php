...
<?php if ($zbp->Config('xxmy')->PostLBRZKG=='1') { ?><div class="riqi"><span><?php  echo $article->Time('m月');  ?></span><span class="f"><?php  echo $article->Time('d日');  ?></span></div><?php } ?>
<h2><a target="_blank" href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>"><?php  echo $article->Title;  ?></a></h2>
