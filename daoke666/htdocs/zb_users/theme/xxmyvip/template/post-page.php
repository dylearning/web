...
<h1>{$article.Title}</h1>
<h6><span>{$article.ViewNums}</span>&nbsp;人参与&nbsp;&nbsp;{$article.Time('Y年m月d日 H:i')}&nbsp;&nbsp;<a href="#pinglun">评论</a></h6>
</div></div>
...
<div id="contabcomment2" class="weixianshi"><div class="cuowu-tishi">{$zbp->Config('xxmyvip')->PostAD5}</div></div>
