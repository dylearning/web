        ...
        <div class="r body-right"><!-- 右侧主体内容 -->
			<div class="bor-sty right-app-info asce-order">
                ...
                <?php $apps = $c->get_recommend(array('area_id'=>2,'pagesize'=>10,'count'=>0,'rewrite'=>SITE_REWRITEURL,'where'=>'(area_type=3 )'));//print_r($a);?>
                <div class="l ranking">
                    <ul>
                        ...
                        <li>
                            <p class="open" <?php if($k!=0) echo "style='display:none;'" ?>>
                                ...
                                <span class="r info-and-download">
                                    ...
                                    <a href="<?php echo $v['surl'];?>" class="dwd">查看详情</a>
                                </span>
                            </p>
            ...
            <p class="line-t-10"></p>
            <div class="bor-sty right-app-info asce-order">
                <span class="rank-title">安卓推荐</span>
            ...
            <p class="line-t-10"></p>
            <div class="bor-sty right-app-info asce-order">
                <span class="rank-title">苹果推荐</span>
