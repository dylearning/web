...
<title><?php echo $c->categories[$cid]['cname'].' - 手赚网 - '.SITE_NAME;?></title>
...
<link rel="icon" href="http://www.yixiangzhuan.com/templates/default/css/img/favicon.ico">
        ...
        <div class="marauto">
            ...
            <div class="l body-left"> <!-- 左侧主体内容 -->
                <div class="pr zIndex10 tab-content">
                    ...
                    <?php $lists = $c->get_list(array('pagesize'=>18,'count'=>1,'cate_id'=>$cid,'rewrite'=>SITE_REWRITEURL,'p'=>$p));
                    //print_r($lists['sql']);
                    ?>
                        ...
                        <?php if(!empty($lists['list'])){foreach($lists['list'] as $key=> $val){?>
                          ...
                          <div class="app-cnt ">
                            ...
                            <div class="app-info">
                                ...
                                <p class="app-data">
                                    <span>时间：&nbsp;&nbsp;<em><?php echo date("Y-m-d",$val['app_update_time']);?></em></span>&nbsp
									<br>
									
                                    <span>支持：&nbsp;&nbsp;<em><?php echo $val['app_system']; ?></em></span>
                                    <br>
									<span>大小：&nbsp;&nbsp;<em><?php echo $val['app_size']; ?></em></span>
									<br>
									
									<div class="app-btn">
                                <a class="btn-down" href="<?php echo $val['surl']; ?>">查看详情</a>
