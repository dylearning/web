...
define("SITE_URL", "http://www.shiwan521.com"); //站点域名
...
define("UPLOAD_CODE", "c3Wk84"); //上传安全码，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("UPLOAD_KEY", "O-OAX1"); //上传密钥，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("COMMENT_CODE", "   "); //评论代码
define("APP_IMG_LOCAL", "0"); //添加应用是否图片本地化
define("CONTENT_NLINK", "1"); //是否开启正文内链
define("COUNT_CODE", ""); //统计代码
define("SEO_TITLE", "苹果手机App试玩赚钱平台汇总_精选苹果试玩App平台排行榜_手赚喵"); //首页SEO标题
define("SEO_KEYWORDS", "试玩App赚钱,App试玩赚钱,苹果试玩App平台,App试玩平台汇总"); //首页关键词
define("SEO_DESCRIPTION", "手赚喵专注于苹果App试玩平台赚钱,精选推荐最新靠谱的苹果手机试玩App赚钱平台汇总排行榜,专业发布手机试玩App平台应用软件,不矫揉造作,只推荐真实项目。"); //首页描述
define("CONTENT_MOBILE", "1"); //是否开启手机版
define("WAP_URL", ""); //手机版独立域名
define("WAP_LOGO", "/upload/img/2019/05/29/5cee44b3ea8f6.png"); //手机版图片
define("WAP_TPL", "mobile"); //手机版模板
define("CACHE_TIME", "");
define("UNION_ID", "");
define("BAIDU_SUBMIT", "");

define("IMG_REWRITE", "1");
