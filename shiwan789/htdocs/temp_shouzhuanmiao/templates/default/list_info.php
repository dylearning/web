...
<meta name="keywords" content="<?php echo $c->categories[$cid]['ckey'];?>" />
<meta name="description" content="<?php echo $c->categories[$cid]['cdesc'];?>" />
...
<?php require_once ('inc_head.php');?>
    <div class="warp-content"> <!-- 主体内容 开始 -->
        ...
        <div class="locate">
            ...
            <p class="line-t-10"></p>
			<?php $infos = $c->get_list(array('type'=>'1','count'=>'1','cate_id'=>$cid,'rewrite'=>SITE_REWRITEURL,'order'=>'order by info_order desc','pagesize'=>PAGESIZE,'p'=>$p));//print_r($infos);?>
