        ...
        <div class="top-bar-area">
            <div class="marauto">
               <div class="l bar-left" style="color:#aaa;">
                    <a class="web-name" href="<?php echo SITE_URL;?>"><?php echo SITE_NAME;?></a>&nbsp;&nbsp;&nbsp;&nbsp;<?php $a=$c->get_app_info_count();echo('应用：'.$a['app_total'].' 当日：'.$a['app_today'].' 新闻：'.$a['info_total'].' 当日：'.$a['info_today'].' '); ?>  <font color="#FF0000" style=" font-weight:bold; padding-left:15px">客服微信-【daokedream】</font>
                </div>
